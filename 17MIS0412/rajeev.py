...
new_data['PRICE'] = new_data['PRICE'].apply(convert).astype('float')
new_data.to_csv(r'temp\temp_filtered_country.csv',index=False)

first_and_second_min_prices = pd.read_csv(r"temp\temp_filtered_country.csv")
...
temp_data.to_csv(r'temp\temp_price.csv',index_label="SKU")
df = pd.read_csv(r"temp\temp_price.csv")
